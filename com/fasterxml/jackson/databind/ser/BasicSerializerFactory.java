...
public abstract class BasicSerializerFactory extends SerializerFactory implements Serializable {
    ...
    protected final JsonSerializer<?> findSerializerByPrimaryType(SerializerProvider serializerProvider, JavaType javaType, BeanDescription beanDescription, boolean z) {
        ...
        if (!Number.class.isAssignableFrom(rawClass)) {
            ...
            if (findExpectedFormat != null) {
                switch (C06381.$SwitchMap$com$fasterxml$jackson$annotation$JsonFormat$Shape[findExpectedFormat.getShape().ordinal()]) {
    ...
    protected JsonSerializer<?> buildIteratorSerializer(SerializationConfig serializationConfig, JavaType javaType, BeanDescription beanDescription, boolean z) {
        ...
        return new IteratorSerializer(containedType, z, createTypeSerializer(serializationConfig, containedType), null);
    }
    ...
    protected JsonSerializer<?> buildIterableSerializer(SerializationConfig serializationConfig, JavaType javaType, BeanDescription beanDescription, boolean z) {
        ...
        return new IterableSerializer(containedType, z, createTypeSerializer(serializationConfig, containedType), null);
    }
