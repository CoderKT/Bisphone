...
public interface zzt extends IInterface {
    ...
    public abstract class zza extends Binder implements zzt {
        ...
        class zza implements zzt {
            ...
            public void m8712a(ResolveAccountResponse resolveAccountResponse) {
        ...
        public static zzt m8713a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case C1128R.styleable.StickyListHeadersListView_android_paddingLeft /*2*/:
                    ...
                    m8711a(parcel.readInt() != 0 ? (ResolveAccountResponse) ResolveAccountResponse.CREATOR.createFromParcel(parcel) : null);
    ...
    void m8711a(ResolveAccountResponse resolveAccountResponse);
}
