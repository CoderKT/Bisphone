...
public interface zzm extends IInterface {
    ...
    public abstract class zza extends Binder implements zzm {
        ...
        class zza implements zzm {
            private IBinder f6356a;

            zza(IBinder iBinder) {
                this.f6356a = iBinder;
            }

            public boolean m10040a(zzf com_google_android_gms_maps_model_internal_zzf) {
                boolean z = true;
                ...
                try {
                    ...
                    this.f6356a.transact(1, obtain, obtain2, 0);
        ...
        public static zzm m9563a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case C1128R.styleable.StickyListHeadersListView_android_padding /*1*/:
                    ...
                    boolean a = m9562a(com.google.android.gms.maps.model.internal.zzf.zza.m10359a(parcel.readStrongBinder()));
    ...
    boolean m9562a(zzf com_google_android_gms_maps_model_internal_zzf);
}
