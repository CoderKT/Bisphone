...
public interface zzu extends IInterface {
    ...
    public abstract class zza extends Binder implements zzu {
        ...
        class zza implements zzu {
            private IBinder f6364a;

            zza(IBinder iBinder) {
                this.f6364a = iBinder;
            }

            public void m10061a(StreetViewPanoramaOrientation streetViewPanoramaOrientation) {
                ...
                try {
                    ...
                    this.f6364a.transact(1, obtain, obtain2, 0);
        ...
        public static zzu m10062a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case C1128R.styleable.StickyListHeadersListView_android_padding /*1*/:
                    ...
                    m10060a(parcel.readInt() != 0 ? StreetViewPanoramaOrientation.CREATOR.m10464a(parcel) : null);
    ...
    void m10060a(StreetViewPanoramaOrientation streetViewPanoramaOrientation);
}
