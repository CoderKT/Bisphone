...
public interface zzi extends IInterface {
    ...
    public abstract class zza extends Binder implements zzi {
        ...
        class zza implements zzi {
            private IBinder f6352a;

            zza(IBinder iBinder) {
                this.f6352a = iBinder;
            }

            public void m10035a(LatLng latLng) {
                ...
                try {
                    ...
                    this.f6352a.transact(1, obtain, obtain2, 0);
        ...
        public static zzi m10036a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case C1128R.styleable.StickyListHeadersListView_android_padding /*1*/:
                    ...
                    m10034a(parcel.readInt() != 0 ? LatLng.CREATOR.m10440a(parcel) : null);
