...
public interface zzf extends IInterface {
    ...
    public abstract class zza extends Binder implements zzf {
        ...
        class zza implements zzf {
            ...
            public void m10024a(zzd com_google_android_gms_maps_model_internal_zzd) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IOnIndoorStateChangeListener");
        ...
        public static zzf m10025a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                ...
                case C1128R.styleable.StickyListHeadersListView_android_paddingLeft /*2*/:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IOnIndoorStateChangeListener");
                    m10022a(com.google.android.gms.maps.model.internal.zzd.zza.m10306a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void m10022a(zzd com_google_android_gms_maps_model_internal_zzd);
}
