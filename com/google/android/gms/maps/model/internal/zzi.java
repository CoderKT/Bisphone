...
public interface zzi extends IInterface {
    ...
    public abstract class zza extends Binder implements zzi {
        ...
        class zza implements zzi {
            private IBinder f6485a;

            zza(IBinder iBinder) {
                this.f6485a = iBinder;
            }

            public Tile m10425a(int i, int i2, int i3) {
                ...
                try {
                    ...
                    obtain.writeInt(i2);
                    obtain.writeInt(i3);
                    this.f6485a.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                    Tile a = obtain2.readInt() != 0 ? Tile.CREATOR.m10467a(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
                    return a;
                } catch (Throwable th) {
        ...
        public static zzi m10426a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case C1128R.styleable.StickyListHeadersListView_android_padding /*1*/:
                    ...
                    Tile a = m10424a(parcel.readInt(), parcel.readInt(), parcel.readInt());
    ...
    Tile m10424a(int i, int i2, int i3);
}
